    ...
    useEffect(() => {
      const fetchMovies = async () => {
        try {
          ...
          setTimeout(()=>{setLoading(1); console.log(movies);},500);
        ...
        <>
        {
            loading? <MoviesContainer>
            {
                movies.map(function(movie,i){
                    return(
                        <MovieContent key={i}>
                            <MoviePoster onClick={()=>{setModal(1); setNum(i);}}>
                        ...
                        {
                            modal? <MoiveDetail movies={movies} i = {i} num = {num} setModal = {setModal}/> : null
                        }
                    </MovieContent>
                    )
                })    
